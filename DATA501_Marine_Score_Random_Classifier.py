...
bins_biodiversity = [50, 65, 80, 100]  # Upper limits for Low, Moderate, and High
labels_biodiversity = ["Low", "Moderate", "High"]
reversed_labels = list(reversed(labels_biodiversity))
...
X = data[feature_col]
y_label = data["Biodiversity_Category"]
