...
print("\n=== APPROACH 2: Feature Engineering ===")
data["Temp_DO_Interaction"] = (
    data["Water_Temperature_C"] * data["Dissolved_Oxygen_mg_L"]
)
...
best_model_acc, best_model, best_X_test, best_y_test, best_y_pred = accuracies[
    best_model_name
]
...
cm = confusion_matrix(best_y_test, best_y_pred, labels=reversed_labels)
...
plt.tight_layout()
plt.savefig("SHI best_model_confusion_matrix.png")
plt.show()
...
if isinstance(best_model, RandomForestClassifier):
    ...
    plt.tight_layout()
    plt.savefig("SHI rf_feature_importances.png")
    plt.show()
